...
class Flickr {
    ...
    private func getPhotos(photoData: [[String: AnyObject]]) -> [FlickrModel] {
        let photos: [FlickrModel] = photoData.compactMap { photoObject in
            guard
            ...
            let flickrPhoto = FlickrModel(title: title,
                                          photoID: photoID,
                                          farm: farm,
                                          server: server,
                                          secret: secret)
